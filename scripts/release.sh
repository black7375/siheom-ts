...
publish_packages() {
  ...
  local publish_rows=""
  for package in "@siheom/core" "@siheom/react" "@siheom/vue" "@siheom/svelte" "@siheom/solid" "@siheom/angular" "@siheom/qwik" "@siheom/react-native" "@siheom/ime" "@siheom/vitest-browser-react"; do
