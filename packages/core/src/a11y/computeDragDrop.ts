...
export function computeDropeffect(el: Element, isVerbose = false): string | null | undefined {
...
export function computeDragDrop(el: Element, isVerbose = false): A11yDragDrop | undefined {
