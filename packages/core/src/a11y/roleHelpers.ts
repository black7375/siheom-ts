...
function getSelectorSpecificity({ attributes = [] }: Partial<ARIAQueryElement>): number {
  return attributes.length;
}

function buildElementRoleList(elementRolesMap: typeof elementRoles): ElementRoleEntry[] {
