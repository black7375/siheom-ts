...
export function computeAtomic(el: Element, isVerbose = false): boolean | null | undefined {
...
export function computeRelevant(el: Element, isVerbose = false): string | null | undefined {
