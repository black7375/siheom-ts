...
const GETTING_STARTED = {
	...
	items: [
		...
		{ text: "Solid 빠른 시작", link: "/getting-started/solid" },
...
const EXAMPLES = {
	...
	items: [
		...
		{ text: "Document Actions", link: "/examples/document-actions" },
		{ text: "Command Menu", link: "/examples/command-menu" },
		{ text: "Team Invite", link: "/examples/team-invite" },
		{ text: "Notice Search", link: "/examples/notice-search" },
		{ text: "View Switcher", link: "/examples/view-switcher" },
		{ text: "Task Table", link: "/examples/task-table" },
		{ text: "Order Tracking", link: "/examples/order-tracking" },
		{ text: "Meeting Booking", link: "/examples/meeting-booking" },
		{ text: "Save Feedback", link: "/examples/save-feedback" },
		{ text: "Mobile Filter", link: "/examples/mobile-filter" },
		{ text: "Billing Alert", link: "/examples/billing-alert" },
		{ text: "Profile Avatar", link: "/examples/profile-avatar" },
		{ text: "Two Factor", link: "/examples/two-factor" },
		{ text: "App Shell", link: "/examples/app-shell" },
		{ text: "Kanban", link: "/examples/kanban" },
		{ text: "Chart Dashboard", link: "/examples/chart-dashboard" },
		{ text: "LLM Chat", link: "/examples/llm-chat" },
	],
};
...
const GETTING_STARTED_EN = {
	...
	items: [
		...
		{ text: "Solid quick start", link: "/en/getting-started/solid" },
...
const EXAMPLES_EN = {
	...
	items: [
		...
		{ text: "Settings", link: "/en/examples/settings" },
		{ text: "Document Actions", link: "/en/examples/document-actions" },
		{ text: "Command Menu", link: "/en/examples/command-menu" },
		{ text: "Team Invite", link: "/en/examples/team-invite" },
		{ text: "Notice Search", link: "/en/examples/notice-search" },
		{ text: "View Switcher", link: "/en/examples/view-switcher" },
		{ text: "Task Table", link: "/en/examples/task-table" },
		{ text: "Order Tracking", link: "/en/examples/order-tracking" },
		{ text: "Meeting Booking", link: "/en/examples/meeting-booking" },
		{ text: "Save Feedback", link: "/en/examples/save-feedback" },
		{ text: "Mobile Filter", link: "/en/examples/mobile-filter" },
		{ text: "Billing Alert", link: "/en/examples/billing-alert" },
		{ text: "Profile Avatar", link: "/en/examples/profile-avatar" },
		{ text: "Two Factor", link: "/en/examples/two-factor" },
		{ text: "App Shell", link: "/en/examples/app-shell" },
		{ text: "Kanban", link: "/en/examples/kanban" },
		{ text: "Chart Dashboard", link: "/en/examples/chart-dashboard" },
		{ text: "LLM Chat", link: "/en/examples/llm-chat" },
	],
};
