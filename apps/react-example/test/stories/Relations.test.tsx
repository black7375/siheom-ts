...
import { assertions, query } from "@siheom/react";
  ...
  return (
    <form aria-label="relations-demo">
      ...
      <div id="panel" aria-labelledby="panel-title">
        ...
        <button id="toggle-btn" type="button" aria-controls="panel" aria-expanded="true">
          Toggle Panel
        </button>
      </div>

      <section id="detail-info" aria-label="Feature details">
        More information about this feature
      </section>
      <button type="button" aria-details="detail-info">
        Help
      </button>
      ...
      <nav aria-label="Main navigation">
        ...
        <button type="button" aria-owns="menu" aria-haspopup="menu">
          Menu
        </button>
      </nav>
    </form>
